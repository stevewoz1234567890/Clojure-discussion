...
- **[Raster 0.1.1 — Fast numerical computing for Clojure](discussions/raster-0.1.1.md)** — [`org.replikativ/raster`](https://clojars.org/org.replikativ/raster) **0.1.1** ([replikativ/raster](https://github.com/replikativ/raster)): **`deftm`** typed dispatch, **`par/map`** / SOAC fusion, forward & reverse AD, nanopass compiler, ODE/optim/linalg/deep learning, GPU backends; **`compile-aot`** for hot paths. **JDK 24+** (Valhalla **JDK 27** recommended). [Docs & notebooks](https://replikativ.github.io/raster/). Chat: **`#simmis`** on Clojurians. Thanks to [replikativ](https://github.com/replikativ) and Raster contributors.
