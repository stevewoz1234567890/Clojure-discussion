...
- **[Practicalli nvim-astro — Clojure on Neovim 0.12](discussions/practicalli-nvim-astro.md)** — [practicalli/nvim-astro](https://github.com/practicalli/nvim-astro) ([release 2026-04-08](https://github.com/practicalli/nvim-astro/releases/tag/2026-04-08)): **AstroNvim v6**, **Conjure**, paredit/parinfer, Tree-sitter, **Mason** + **`clojure-lsp`**, lazy loading, **LazyGit** / **Neogit**; neo-tree → **`snacks.picker.explorer`**, markdown (**marksman**) & bash packs. Thanks to [Practicalli](https://github.com/practicalli).
- **[`tree-sitter-clojure` (WASM) & Chiasmus](discussions/tree-sitter-clojure-wasm-chiasmus.md)** — npm [`@yogthos/tree-sitter-clojure`](https://www.npmjs.com/package/@yogthos/tree-sitter-clojure) (no native deps); **[chiasmus](https://github.com/yogthos/chiasmus)** MCP: JS sandbox + Tree-sitter + **Prolog**/**Z3**, graph queries vs grep ([arXiv:2305.00813](https://arxiv.org/abs/2305.00813)); **[sporulator](https://github.com/mycelium-clj/sporulator)** (React Flow). Thanks to [@yogthos](https://github.com/yogthos).
