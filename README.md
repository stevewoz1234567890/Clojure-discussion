...
- **[pandō — structural Clojure for agents (MCP)](discussions/pando-structural-clojure-mcp.md)** — **[clojure.getpando.ai](https://clojure.getpando.ai)**: **AST-based** navigation/editing for **coding agents**; **namespace-aware** rename/refactor/transform; **complements** existing tools over **MCP**; **free** for personal use, **not** OSS. Announcement-style community note.
